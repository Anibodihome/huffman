...
namespace Huffman.Common.Print
{
    public class DataGridViewPrinter
    {
            ...
            if (PageNumber == 0) // Just calculate once
            {
                ...
                for (int i = 0; i < TheDataGridView.Columns.Count; i++)
                {
                    ...
                    for (int j = 0; j < TheDataGridView.Rows.Count; j++)
                    {
                        ...
                        tmpSize = g.MeasureString("ÎÄ×Ö", tmpFont);
        ...
        private void DrawHeader(Graphics g)
        {
            ...
            {
                PageNumber++;
                string PageString = "µÚ " + PageNumber.ToString() + " Ò³";
                ...
                Font PageStringFont = new Font("ËÎÌå", 9, FontStyle.Regular, GraphicsUnit.Point);
